...
export default function InteractiveTutorial({
  ...
  const steps: TutorialStep[] = [
    ...
    },
    {
      ...
      textEn: 'Invite other creators to PayBio and earn 10% lifetime recurring commission on all their Premium upgrades!',
      textRu: 'Приглашайте других авторов и получайте пожизненную комиссию 10% от всех оплат подписок Premium ваших рефералов!',
    ...
    },
    {
      ...
      textEn: 'Put your storefront link in your Telegram bio or channel description. Good luck with your sales!',
      textRu: 'Разместите ссылку на витрину в описании профиля (Bio) Telegram или вашего канала. Желаем успешных продаж!',
      action: () => setCurrentScreen('CATALOG'),
    },
  ];
